...
/**
 * v1 design, kept unmodified for side-by-side comparison against the
 * current SiteProfile. Viewable at /s/[slug]/classic.
 */
export default function SiteProfileClassic({ site }: { site: SiteConfig }) {
